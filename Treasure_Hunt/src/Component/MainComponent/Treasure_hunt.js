...
import t1 from './Treasure.module.css';
...
export default function About() {
  return (
    <div>
          ...
          <div className="container">
            ...
            <div className="collapse navbar-collapse" id="navbarNav">
              <ul className="navbar-nav ms-auto ">
                ...
                <li className="nav-item">
                  <a className="nav-a" href="/Selection">selection</a>
                </li>
                <li className="nav-item">
                  <a className="nav-a" href="/Schedule">Schedule</a>
                </li>
                <li className="nav-item">
        ...
        <div className="container">
          <div className="row">
            <div className="col-12 mt-2 mx-auto">
              ...
              <h1 className=" display-1  fw-bold ">Treasur Hunt</h1>
              <Link to="/Register" className=" m-5 glow">               
                Register Now
              </Link>
            </div>
          </div>
      ...
      <section id="about" className="bg-light text-center">
        <div className="container">
          ...
          <div className="row g-4">
            <div className="col-lg-4 col-sm-6 card1">
              <div className="feature-box">
                <div className="icon-box"><img src="/img/body/10.png" alt="" /></div>
                <h5>Start</h5>
            ...
            <div className="col-lg-4 col-sm-6 card1">
              <div className="feature-box">
                <div className="icon-box"><img src="/img/body/11.png" alt="" /></div>
                <h5>Team</h5>
            ...
            <div className="col-lg-4 col-sm-6 card1">
              <div className="feature-box">
                <div className="icon-box"><img src="/img/body/13.png" alt="" /></div>
                <h5>Decode</h5>
            ...
            <div className="col-lg-4 col-sm-6 card1">
              <div className="feature-box">
                <div className="icon-box"><img src="/img/body/12.png" alt="" /></div>
            ...
            <div className="col-lg-4 col-sm-6 card1">
              <div className="feature-box">
                <div className="icon-box"><img src="/img/body/14.png" alt="" /></div>
                <h5>Digital era</h5>
            ...
            <div className="col-lg-4 col-sm-6 card1">
              <div className="feature-box">
                <div className="icon-box"><img src="/img/body/15.png" alt="" /></div>
      ...
      {/* Selection  */}
      <section id="selection" className="theme">
        <div className="container">
          <div className="row">
            <div className="col-12 intro text-center">
          ...
          <div className="row justify-content-center g-4">
            <div className="col-lg-6 col-sm-12 card2">
              <div className="selection">
                <div className="icon-box"><img src="/img/body/q1.png" alt="" /></div>
                <div>
                  <h6>Round 1</h6>
            ...
            <div className="col-lg-6 col-sm-12 card2">
              <div className="selection">
                <div className="icon-box"><img src="/img/body/q2.png" alt="" /></div>
                <div>
                  <h6>Round 2</h6>
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore nobis, eius quia
                    assumenda corrupti voluptatum.</p>
            ...
            <div className="col-lg-6 col-sm-12 card2">
              <div className="selection">
                <div className="icon-box"><img src="/img/body/q3.png" alt="" /></div>
                <div>
                  <h6>Round 3</h6>
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore nobis, eius quia
                    assumenda corrupti voluptatum.</p>
            ...
            <div className="col-lg-6 col-sm-12 card2">
              <div className="selection">
                <div className="icon-box"><img src="/img/body/q4.png" alt="" /></div>
                <div>
                  <h6>Round 4</h6>
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore nobis, eius quia
                    assumenda corrupti voluptatum.</p>
            ...
            <div className="col-lg-6 col-sm-12 card2">
              <div className="selection">
                <div className="icon-box"><img src="/img/body/q5.png" alt="" /></div>
                <div>
                  <h6>Round 5</h6>
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore nobis, eius quia
                    assumenda corrupti voluptatum.</p>
            ...
            <div className="col-lg-6 col-sm-12 card2">
              <div className="selection">
                <div className="icon-box"><img src="/img/body/q6.png" alt="" /></div>
                <div>
                  <h6>Finale</h6>
                  <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Inventore nobis, eius quia
                    assumenda corrupti voluptatum.</p>
      ...
      <section className="bg-light" id="Schedule">
        ...
        <div className="timeline">
          <ul>
            <li>
              <div className="content" data-center-center="opacity:1;top:0" data-0-bottom="opacity:0;top:-500px">
                <h3>Round 1</h3>
                <p>Quiz</p>
              </div>
              <div className="point" />
              <div className="date" data-center-center="opacity:1;bottom:0" data-0-bottom="opacity:0;bottom:-500px">
                <h4>Date</h4>
              </div>
            </li>
            <li>
